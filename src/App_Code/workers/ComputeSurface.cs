...
public class ComputeSurface
{
    ...
    private double[] AdjustCompletePSTR(double[] PSTR)
    {
        IList<double> roundPSTR = new List<double>();
        ...
        double total = this.Sum(roundPSTR.ToArray()), countLimit = 0;
    ...
    private double[] AdjustIncompletePSTR(double[] PSTR)
    {
        IList<double> roundPSTR = new List<double>();
    ...
    private double PRound(double value)
    {
